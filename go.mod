...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.6.1-0.20260428063333-0a225c8d5510
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.6.1-0.20260430090237-a4265c18a162
