...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.6.1-0.20260514205908-14d0126aa52f
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.6.1-0.20260515134210-2e2a0d06648c
