...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.4.1-0.20240809142323-73a1c7859145
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.4.1-0.20240808095747-579da98fa7a6
