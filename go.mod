...
require (
	...
	github.com/openstack-k8s-operators/dataplane-operator/api v0.3.1-0.20240226170244-cafe60d110bc
...
require (
	...
	github.com/openstack-k8s-operators/openstack-baremetal-operator/api v0.3.1-0.20240222051903-0f74dcdc7782 // indirect
