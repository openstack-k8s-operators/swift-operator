...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.6.1-0.20260806184421-f3cf63da229e
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.6.1-0.20260806140515-16161b7b6b53
