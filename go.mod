...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.4.1-0.20240924165126-7025f72ad7f3
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.4.1-0.20240925091112-d0fa8e528283
