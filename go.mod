...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.6.1-0.20260724164726-fedb6bb20091
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.6.1-0.20260724091355-a86f6d29e055
