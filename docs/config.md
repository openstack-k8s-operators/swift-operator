...
```
alias swift-ring-builder="podman run -it --userns=keep-id:uid=42445 -v .:/etc/swift:Z -w /etc/swift quay.io/openstack-s2i-containers/openstack-swift-proxy-server:master-latest swift-ring-builder"
```
