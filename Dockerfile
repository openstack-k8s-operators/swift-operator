...
ARG IMAGE_COMPONENT="swift-operator-container"
ARG IMAGE_NAME="swift-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Swift Operator"
ARG IMAGE_DESC="This image includes the swift-operator"
...
ENV USER_UID=$USER_ID \
    OPERATOR_TEMPLATES=/usr/share/swift-operator/templates/
